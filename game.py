...
# player_number = input('👾 Type number of players:')
# print(f'The game will be configured for {player_number} players.')

# # case statement for fast, normal or long session
...
def sample_run():
	...
	game = Game()
	game.initialize_game(board, dice_sides=6, players=2)
	game.play()
